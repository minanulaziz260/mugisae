...
export const metadata: Metadata = {
  title: "Kontak",
  description:
    "Hubungi PKBM Mugi Sae melalui WhatsApp, email, atau kunjungi langsung kantor kami di Jatibarang, Brebes, Jawa Tengah.",
};
              ...
              <div className="overflow-hidden rounded-[28px] border border-border bg-card shadow-md">
                ...
                <div className="flex items-center justify-between gap-4 border-t border-border bg-bg/50 px-5 py-4 text-sm">
                  <div className="flex items-center gap-2 text-muted">
                    ...
                    <span>Jatibarang, Brebes, Jawa Tengah</span>
                  </div>
                  <a
                    href="https://www.google.com/maps/search/?api=1&query=PKBM+MUGI+SAE+Jatibarang+Brebes"
                    target="_blank"
                    rel="noopener noreferrer"
